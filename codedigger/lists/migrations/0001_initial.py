# Generated by Django 3.1.4 on 2020-12-18 07:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('problem', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='lists.problem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problem', models.ManyToManyField(related_name='list', to='lists.Problem')),
            ],
        ),
    ]
